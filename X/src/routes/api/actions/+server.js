...
const ACTIONS = new Set(['start', 'stop', 'restart', 'update', 'reload-code', 'install', 'delete-application', 'sync-integrations', 'update-integration', 'delete-integration', 'update-all-integrations', 'scan-repository']);
